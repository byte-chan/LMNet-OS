...
local bMenu = false
local nMenuItem = 1
local tMenuItems = {"Save", "Exit", "Print", "GoTo"}
...
local tMenuFuncs = { 
 ...
 GoTo=function()
  ...
  term.write("Enter desired line: ")
  line = read()
  if line ~= nil and tonumber(line) ~= nil then
    if tonumber(line) > #tLines then
      y = #tLines
    else
      y = tonumber(line)
    end
